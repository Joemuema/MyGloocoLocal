...
import '/components/edit_reminder_name_widget.dart';
                                          ...
                                          onPressed: () async {
                                            ...
                                            await widget.currentReminderID!
                                                .update(
                                                    createRemindersRecordData(
                                              time: functions
                                                  .getTime(_model.datePicked1!),
                                              timeDT: functions.commonTimeDT(
                                                  getCurrentTimestamp),
                                            ));
                                          },
