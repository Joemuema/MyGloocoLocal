                      ...
                      children: [
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  5.0, 0.0, 0.0, 0.0),
                              child: Text(
                                dateTimeFormat("d/M/y", widget.calendarDate),
                                                              ...
                                                              Align(
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    builder:
                                                                        (context) {
                                                                      final mealscolumn = breakfastItem
                                                                          .meals
                                                                          .toList();
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 5.0, 0.0),
                                child: Text(
                                  '${functions.calcTotalKcal(widget.foodItems!.map((e) => e.totalMealKcals).toList()).toString()} Kcal',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        font: GoogleFonts.readexPro(
                        ...
                        if ((widget.foodItems != null &&
                          ...
                          Column(
                            ...
                            children: [
                              wrapWithModel(
                                model: _model.emptyMealPlanModel,
                                updateCallback: () => safeSetState(() {}),
                                child: EmptyMealPlanWidget(
                                  calendarDate: widget.calendarDate!,
                                ),
                              ),
                            ],
                          ),
                        if (functions.currentDate(widget.calendarDate!) >=
