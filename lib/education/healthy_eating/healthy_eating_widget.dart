...
class HealthyEatingWidget extends StatefulWidget {
  const HealthyEatingWidget({super.key});

  static String routeName = 'healthy_eating';
  static String routePath = '/healthyEating';

  @override
  State<HealthyEatingWidget> createState() => _HealthyEatingWidgetState();
}

class _HealthyEatingWidgetState extends State<HealthyEatingWidget> {
  late HealthyEatingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HealthyEatingModel());
                                ...
                                children: [
                                        ...
                                        child: SingleChildScrollView(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Carbohydrate Management: Understand how different types of carbohydrates affect blood sugar levels.\nBalanced Diet: Incorporate a variety of fruits, vegetables, lean proteins, and whole grains into your meals.\nPortion Control: Learn to manage portion sizes to prevent overeating and maintain a healthy weight.',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                                    .override(
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          'For more information on healthy eating with diabetes:\n',
