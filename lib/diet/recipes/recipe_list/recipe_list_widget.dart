...
class RecipeListWidget extends StatefulWidget {
  ...
  static String routeName = 'Recipe_list';
                            ...
                            onTap: () async {
                              context.pushNamed(
                                ...
                                queryParameters: {
                                  ...
                                  'foodPic': serializeParam(
                                    listViewRecipesRecord.picture,
                                    ParamType.String,
                                  ),
                                }.withoutNulls,
                                extra: <String, dynamic>{
                                  'recipeName': listViewRecipesRecord,
                                  'enkcal': listViewRecipesRecord,
                                  'carbs': listViewRecipesRecord,
                                  'proteins': listViewRecipesRecord,
                                  'fats': listViewRecipesRecord,
                                  'ingredients': listViewRecipesRecord,
                                  'instructions': listViewRecipesRecord,
                                },
                              );
                            },
                            child: Container(
