...
import 'exercise_ed_model.dart';
export 'exercise_ed_model.dart';

class ExerciseEdWidget extends StatefulWidget {
  const ExerciseEdWidget({super.key});

  static String routeName = 'exercise_ed';
  static String routePath = '/exerciseEd';

  @override
  State<ExerciseEdWidget> createState() => _ExerciseEdWidgetState();
}

class _ExerciseEdWidgetState extends State<ExerciseEdWidget> {
  late ExerciseEdModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExerciseEdModel());
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  'Improves insulin sensitivity and helps lower blood sugar levels.\nAids in weight management and reduces body fat.\nEnhances cardiovascular health and \nstrengthens muscles.',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                                      .override(
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            'For more information on exercise and diabetes:\n',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
