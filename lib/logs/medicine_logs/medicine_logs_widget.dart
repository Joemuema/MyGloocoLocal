...
class MedicineLogsWidget extends StatefulWidget {
  const MedicineLogsWidget({super.key});

  @override
  State<MedicineLogsWidget> createState() => _MedicineLogsWidgetState();
}

class _MedicineLogsWidgetState extends State<MedicineLogsWidget> {
  late MedicineLogsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MedicineLogsModel());
