...
class RefillWidget extends StatefulWidget {
  ...
  final List<MedicineRecord>? medRefillList;
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemCount: medsToRefill.length,
                                        itemBuilder:
                                            (context, medsToRefillIndex) {
                                          final medsToRefillItem =
                                              medsToRefill[medsToRefillIndex];
                                          return Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                '${medsToRefillItem.totalDose.toString()} ${() {
                                                  if (medsToRefillItem.form ==
                                                      'Pill') {
                                                    return (medsToRefillItem
                                                                .totalDose ==
                                                            1.0
                                                        ? 'capsule'
                                                        : 'capsules');
                                                  } else if (medsToRefillItem
                                                          .form ==
                                                      'Tablet') {
                                                    return (medsToRefillItem
                                                                .totalDose ==
