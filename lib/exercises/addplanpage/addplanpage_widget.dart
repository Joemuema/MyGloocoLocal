...
class AddplanpageWidget extends StatefulWidget {
  const AddplanpageWidget({
    super.key,
  ...
  static String routeName = 'addplanpage';
  static String routePath = '/addplanpage';

  @override
  State<AddplanpageWidget> createState() => _AddplanpageWidgetState();
}

class _AddplanpageWidgetState extends State<AddplanpageWidget> {
  late AddplanpageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddplanpageModel());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        obscureText: false,
                        decoration: InputDecoration(
                          labelText: 'Enter distance covered',
                          labelStyle:
                              FlutterFlowTheme.of(context).labelMedium.override(
                                    font: GoogleFonts.readexPro(
                                      fontWeight: FlutterFlowTheme.of(context)
                          ...
                          child: Padding(
                            ...
                            child: FlutterFlowChoiceChips(
                              ...
                              onChanged: (val) => safeSetState(() =>
                                  _model.intensitychoicechipsValue =
                                      val?.firstOrNull),
                            ...
                            onPressed: () async {
                              await AddpagecollectionRecord.collection
                                  ...
                                  .set(createAddpagecollectionRecordData(
                                    ...
                                    distance: double.tryParse(_model
