                                        ...
                                        return GestureDetector(
                                          ...
                                          child: Padding(
                                            ...
                                            child: ChartSettingsWidget(
                                              ...
                                              unitsUsed: widget.setChartUnits,
                                              chartInterval:
                                                  widget.setInterval,
                                              chartDate:
                                                  _model.currentChartDate!,
                                                                  ...
                                                                  bGreadingsRecord
                                                                      ...
                                                                      .where(
                                                                        ...
                                                                        isGreaterThanOrEqualTo:
                                                                            functions.getDate(functions.firstDayOfWeek(getCurrentTimestamp)),
                                                                      )
                                                                      .orderBy(
                                                                          'Date')
                                                                      .orderBy(
                                                            ...
                                                            (bGreadingsRecord) =>
                                                                bGreadingsRecord
                                                                    ...
                                                                    .where(
                                                                      ...
                                                                      isGreaterThanOrEqualTo:
                                                                          functions
                                                                              .getDate(functions.firstDayOfWeek(_model.currentChartDate!)),
                                                                    )
                                                                    .where(
                                                                      'Date',
                                                                      isLessThan:
                                                                          functions
                                                                              .getDate(functions.firstDayOfWeek(functions.incrementWeek(_model.currentChartDate!))),
                                                                    )
                                                                    .orderBy(
                                                                        'Date')
                                                                    .orderBy(
                                                              ...
                                                              (bGreadingsRecord) =>
                                                                  bGreadingsRecord
                                                                      ...
                                                                      .where(
                                                                        'Date',
                                                                        isGreaterThanOrEqualTo:
                                                                            functions.getDate(functions.firstDayOfMonth(getCurrentTimestamp)),
                                                                      )
                                                                      .orderBy(
                                                                          'Date')
                                                                      .orderBy(
                                                            ...
                                                            (bGreadingsRecord) =>
                                                                bGreadingsRecord
                                                                    ...
                                                                    .where(
                                                                      ...
                                                                      isGreaterThanOrEqualTo:
                                                                          functions
                                                                              .getDate(functions.firstDayOfMonth(_model.currentChartDate!)),
                                                                    )
                                                                    .where(
                                                                      'Date',
                                                                      isLessThan:
                                                                          functions
                                                                              .getDate(functions.firstDayOfMonth(functions.incrementMonth(_model.currentChartDate!))),
                                                                    )
                                                                    .orderBy(
                                                                        'Date')
                                                                    .orderBy(
                            ...
                            if (widget.setChartType == 'single') {
                              return Builder(
                                builder: (context) {
                                  ...
                                  } else if (widget.setInterval == 'weekly') {
                                    return Builder(
                                      builder: (context) {
                                        if (widget.setChartUnits == 'mgdl') {
                                          return Padding(
